...
The actual procecss is mean to be implemented entirely through the script currently labeled **AOK_cleaning_aggregating.R** The markdown (rmd) file was simple made to create the tutorial and enhance documentation.
